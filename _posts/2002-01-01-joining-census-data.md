...
![Spatial Data Carpentry: Unpack zip files]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-unzipped.png)
1. Import Census Tracts shapefile **tl_2014_53_tract.shp** ![Spatial Data Carpentry: Census Join - Add vector layer]({{BASE_PATH}}{{ASSET_PATH}}/images/add-vector.png).<br>
![Spatial Data Carpentry: Census Join - Washington Census tracts]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-1.png)
...
![Spatial Data Carpentry: Census Join - Washington tract attributes]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-2.png)
...
![Spatial Data Carpentry: Census Join - Locate similar columns]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-5.png)
...
![Spatial Data Carpentry: Census Join - Delete housing data annotation]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-6.png)
1. Rename header HD01_VD01 to TotalUnitsHome. Save your document, be sure it's stored as a Text CSV ![Spatial Data Carpentry: Census Join - Save as Text CSV]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-8.png). Excel users may have to select Text CSV from a drop-down list. Renaming the headers reduces confusion down the road. Also, notice how there are no spaces in the header name. Removing (or not having) spaces is in the top 10 list of best naming convention practices (on all computer systems.. everywhere in the digital world.. you should never have spaces in your file names or directories). Close the document.<br>
![Spatial Data Carpentry: Census Join - Rename HD01_VD01 to MeanValueHome]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-7.png)
...
* Save your document in Text CSV format ![Spatial Data Carpentry: Census Join - Save as Text CSV]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-8.png)<br>
![Spatial Data Carpentry: Census Join - Wrangle Home Values CSV]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-9.png)
...
![Spatial Data Carpentry: Census Join - Tract field data types]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-12.png)
1. Open a text editr (gedit, VIM, notepad, notepad++) and enter the following:<br>
``"String","Real(12.0)"``<br>
![Spatial Data Carpentry: Census Join - Creating a CSVT]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-13.png)
What this means:<br>
...
![Spatial Data Carpentry: Census Join - Viewing housing-units.csvt]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-14.png)
...
![Spatial Data Carpentry: Census Join - Drag and drop CSVs]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-15.png)
1. Your workspace should look like the image below. Save your workspace now.<br>
![Spatial Data Carpentry: Census Join - Workspace]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-16.png)
...
![Spatial Data Carpentry: Census Join - view tracts properties]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-17.png)
...
![Spatial Data Carpentry: Census Join - joining data]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-18.png)
...
![Spatial Data Carpentry: Census Join - viewing joined data]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-19.png)
...
![Spatial Data Carpentry: Census Join - save shapefile]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-20.png)
...
![Spatial Data Carpentry]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-hmvalthnds.png)
...
![Spatial Data Carpentry: Census Join - field calculator]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-totalvalue.png)
...
![Spatial Data Carpentry: Census Join - TotalValue per tract]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-22.png)
...
![Spatial Data Carpentry: Symbolize census tracts]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-symbolize.png)
...
![Spatial Data Carpentry: Census Join - completed]({{BASE_PATH}}{{ASSET_PATH}}/images/census-join-24.png)
